...
export const initializeDb = () => {
  expoDb.execSync(
    'CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, email TEXT NOT NULL, access_token TEXT, refresh_token TEXT, synced INTEGER DEFAULT 0); ' +
